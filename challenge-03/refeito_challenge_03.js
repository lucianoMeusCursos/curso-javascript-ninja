...
console.log('pessoa.mostrarIdade()', pessoa.mostrarIdade());
...
console.log('pessoa.mostrarPeso()', pessoa.mostrarPeso());

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
  inline ao lado da instrução para mostrar qual foi a resposta retornada)
  */
 console.log('pessoa.mostrarAltura()', pessoa.mostrarAltura());
...
console.log("Pessoa fez 3 aniversários ", pessoa.idade );
...
pessoa.apresentacao = () => {
  ...
  return `Olá, eu sou ${fraseGenero} ${nome} ${sobrenome}, tenho ${idade} ${"ano" + mudaPlural(idade)}, ${altura}, meu peso é ${peso} e, só hoje, eu já caminhei ${caminhouQuantosMetros} ${'metro' + mudaPlural(caminhouQuantosMetros)}!`
}
